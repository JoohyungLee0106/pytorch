...
###########################################################################################################
SAVE_FOLDER_NAME = 'mxp_16'
FEATURE_NUM=16
MINI_BATCH_SIZE = 16
PARAMS_NETWORK = {'pretrained':False,'dilations':True, 'global_pooling': 'mxp','arch':'resnet34', 'block':networks.BasicBlock,
                  'base_width':FEATURE_NUM,'starting_filter_num':FEATURE_NUM, 'lated': False, 'my_device': torch.device(MY_DEVICE)}
...
SAVE_FOLDER_NAME = 'avp_64prt'
FEATURE_NUM=64
MINI_BATCH_SIZE = 8
PARAMS_NETWORK = {'pretrained':True,'dilations':True, 'global_pooling': 'avp','arch':'resnet34', 'block':networks.BasicBlock,
                  'base_width':FEATURE_NUM,'starting_filter_num':FEATURE_NUM, 'lated': False, 'my_device': torch.device(MY_DEVICE)}
...
###########################################################################################################
SAVE_FOLDER_NAME = 'mxp_64prt'
FEATURE_NUM=64
MINI_BATCH_SIZE = 8
PARAMS_NETWORK = {'pretrained':True,'dilations':True, 'global_pooling': 'mxp','arch':'resnet34', 'block':networks.BasicBlock,
                  'base_width':FEATURE_NUM,'starting_filter_num':FEATURE_NUM, 'lated': False, 'my_device': torch.device(MY_DEVICE)}
